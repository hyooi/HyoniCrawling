...
public class SearchWordDao {
	...
	public void getAmountSearches() throws Exception {
		...
		String item = null;
		try {
			doc = Jsoup.connect(connectUrl+URLEncoder.encode("한국시리즈", "UTF-8")+connectUrl2)
					.header("Accept", "application/json, text/plain, */*")
					.header("Accept-encoding", "gzip, deflate, br")
					.header("Accept-language", "ko-KR,ko;q=0.9,en-US;q=0.8,en;q=0.7")
					.header("authorization", "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..yIijWL29NWf07cNyOcTB2ln4K9ELO46YcpuMWchdKLc")
					...
					.userAgent(userAgent).ignoreContentType(true).get();
	...
	public void getLoginToNaverAdSystem() throws Exception {
		...
		String cookieNNB = cookieNNBResponse.cookie("NNB");
		System.out.println(cookieNNB);
		
		/*NNB쿠키가지고 https://searchad.naver.com/auth/login호출. 로그인화면에서 NETWORK보면 확인가능 */
		
		/*로그인 후 TOKEN, COOKIES가지고 getAmountSearches함수 호출해서 값 가져오기*/
	}
}